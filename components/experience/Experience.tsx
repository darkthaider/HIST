        ...
        <TextAnimation>
          ...
          <div className={`justify-end lg:flex block mt-[242px]`}>
            <p className="text-hist_white-800 desc-16-20 max-w-[648px]">
              ...
              challenging, which is why we work closely with our clients to
              ensure that their products are well received and reach their
              target audience. With our expertise, we help our clients overcome
              any obstacles and achieve success in the Middle East.
            </p>
          </div>
        </TextAnimation>
      </div>
