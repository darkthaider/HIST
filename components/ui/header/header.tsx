        ...
        <div className="bg-hist_black md:bg-hist_white-100 pl-4 pr-4 lg:pl-6 lg:pr-6 xl:pl-8 xl:pr-8 py-[13px] flex justify-between items-center rounded-lg">
          ...
          >
            <svg
              ...
              y="0"
              width="140"
              height="40.5973966281023"
              viewBox="52.01660186767578 89.82141143798827 235.96679626464845 70.35717712402344"
            ...
            >
              <g>
                ...
                <g
                  ...
                  transform="translate(54.33000183105469,92.13481140339933)"
                >
                  <g className="iconsvg-imagesvg" transform="translate(0,0)">
                    <g>
                      <rect
                        ...
                        y="0"
                        width="60"
                        height="65.7303740058281"
                        className="image-rect"
                      />{" "}
                      <svg
                        filter="url(#colors5778871051)"
                        x="0"
                        y="0"
                        width="60"
                        height="65.7303740058281"
          ...
          <nav className="mdMax:absolute mdMax:h-screen mdMax:left-0 mdMax:pt-[100px] mdMax:top-0 mdMax:flex mdMax:flex-col mdMax:w-[100%] mdMax:gap-[24px] mdMax:z-[-1] md:flex md:gap-4 lg:gap-6 xl:gap-10 items-center mdMax:overflow-auto justify-center">
            {navLinks.map((item) => (
              <div onClick={navLinkHandler} key={item.link}>
                <Link
                  // prefetch={true}
                  key={item.link}
                  href={item.link}
                  ...
                  target={item.targetBlank ? "_blank" : "_top"}
                >
                  {item.title}
                </Link>
              </div>
            ...
            <button onClick={handleFormToggle} className="animatedBtn contact">
